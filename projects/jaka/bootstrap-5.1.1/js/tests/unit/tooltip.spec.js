...
describe("Tooltip", () => {
  ...
  describe("constructor", () => {
    ...
    it("should allow to pass config to Popper with `popperConfig` as a function", () => {
      ...
      const tooltipEl = fixtureEl.querySelector("a");
      const getPopperConfig = jasmine
        .createSpy("getPopperConfig")
        .and.returnValue({ placement: "left" });
      const tooltip = new Tooltip(tooltipEl, {
  ...
  describe("show", () => {
    it("should show a tooltip", (done) => {
      ...
      tooltipEl.addEventListener("shown.bs.tooltip", () => {
        ...
        expect(tooltipEl.getAttribute("aria-describedby")).toEqual(
          tooltipShown.getAttribute("id")
        );
    ...
    it("should show a tooltip when hovering a children element", (done) => {
      ...
      tooltipEl
        .querySelector("rect")
        .dispatchEvent(createEvent("mouseover", { bubbles: true }));
    ...
    it("should show a tooltip relative to placement option", (done) => {
      ...
      tooltipEl.addEventListener("inserted.bs.tooltip", () => {
        expect(
          tooltip.getTipElement().classList.contains("bs-tooltip-bottom")
        ).toEqual(true);
      });
      ...
      tooltipEl.addEventListener("shown.bs.tooltip", () => {
        ...
        expect(tooltipShown.classList.contains("bs-tooltip-bottom")).toEqual(
          true
        );
        done();
      });
    ...
    it("should not hide tooltip if leave event occurs and enter event occurs within the hide delay", (done) => {
      ...
      setTimeout(() => {
        expect(tooltip.getTipElement().classList.contains("show")).toEqual(
          true
        );
    ...
    it("should properly maintain tooltip state if leave event occurs and enter event occurs during hide transition", (done) => {
      ...
      setTimeout(() => {
        ...
        expect(
          tooltip.getTipElement().getAttribute("data-popper-placement")
        ).toBe("top");
        tooltipEl.dispatchEvent(createEvent("mouseout"));
    ...
    it("should show a tooltip with custom class provided as a function in config", (done) => {
      ...
      const spy = jasmine
        .createSpy("customClass")
        .and.returnValue("custom-class");
      const tooltipEl = fixtureEl.querySelector("a");
      const tooltip = new Tooltip(tooltipEl, {
        customClass: spy,
      });
  ...
  describe("hide", () => {
    ...
    it("should hide a tooltip on mobile", (done) => {
      ...
      tooltipEl.addEventListener("hidden.bs.tooltip", () => {
        expect(document.querySelector(".tooltip")).toBeNull();
        expect(EventHandler.off).toHaveBeenCalledWith(
          jasmine.any(Object),
          "mouseover",
          noop
        );
  ...
  describe("setContent", () => {
    it("should set tip content", () => {
      ...
      expect(tip.classList.contains("fade")).toEqual(false);
      expect(tip.querySelector(".tooltip-inner").textContent).toEqual(
        "Another tooltip"
      );
    });
  });
  ...
  describe("updateAttachment", () => {
    it("should use end class name when right placement specified", (done) => {
      ...
      tooltipEl.addEventListener("inserted.bs.tooltip", () => {
        expect(
          tooltip.getTipElement().classList.contains("bs-tooltip-end")
        ).toEqual(true);
        done();
      });
    ...
    it("should use start class name when left placement specified", (done) => {
      ...
      tooltipEl.addEventListener("inserted.bs.tooltip", () => {
        expect(
          tooltip.getTipElement().classList.contains("bs-tooltip-start")
        ).toEqual(true);
        done();
      });
  ...
  describe("setElementContent", () => {
    ...
    it("should add the child text content in the element", () => {
      ...
      expect(childContent.textContent).toEqual(
        tooltip.getTipElement().textContent
      );
    });
    ...
    it("should add html without sanitize it", () => {
      ...
      expect(tooltip.getTipElement().querySelector("div").id).toEqual(
        "childContent"
      );
    });
  ...
  describe("getOrCreateInstance", () => {
    it("should return tooltip instance", () => {
      ...
      expect(Tooltip.getInstance(div)).toEqual(
        Tooltip.getOrCreateInstance(div, {})
      );
